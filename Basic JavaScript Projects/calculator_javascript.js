...
const Calculator = {
    ...
    First_Operand: null,
    // this checks whether or not the second operand had been input
...
// this function updates the screen wtih the contents of Display_Value
...
keys.addEventListener('click', (event) => {
    // the target variable is an objec tthat represents the element
    // that was clicked
    const { target } = event;
